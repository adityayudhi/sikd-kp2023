...
def akuntansi(request,jenis_akuntansi):
    ...
    if kode_urusan != '' and kode_suburusan != '' and kode_organisasi !='':             
        with connections[tahun_log(request)].cursor() as pejabat_ppk:
    ...
    if jenis_akuntansi=='datalrappkd':
        ...
        array_jenis_laporan = [{'kode':'0','nama':'-- Pilih Jenis Laporan --'},
        {'kode':'1','nama':'Laporan Realisasi Anggaran Pemda Semester Pertama (PROGNOSIS) '},  
        {'kode':'2','nama':'Laporan Realisasi Anggaran SKPD Semester Pertama (PROGNOSIS) '},  
        {'kode':'3','nama':'Laporan Realisasi Penjabaran Anggaran SKPD Semester Pertama (PROGNOSIS) '},  
        {'kode':'4','nama':'Laporan LRA Pemda Triwulanan'},
        {'kode':'5','nama':'Laporan LRA Per SKPD Triwulanan'},
        {'kode':'6','nama':'Rekapitulasi Pendapatan Pemda Bulanan'},
        {'kode':'7','nama':'Rekapitulasi Pendapatan Per SKPD Bulanan'},
        {'kode':'8','nama':'Ringkasan Realisasi Pemda Periode'},
        {'kode':'9','nama':'Ringkasan Realisasi SKPD Periode'},
        {'kode':'10','nama':'Laporan Realisasi Penjabaran Anggaran SKPD Periode'},]
        ...
        # {'kode':'11','nama':'Lampiran 10 Perda (Daftar Dana Cadangan)'},{'kode':'12','nama':'Lampiran 11 Perda (Daftar Pinjaman)'},
        {'kode':'13','nama':'Lampiran Tambahan (Ringkasan Belanja Per Fungsi, Urusan, Organisasi dan Jenis)'} 
        ]
        array_jenis_laporan2 = [
        ...
        array_jenis_laporan = [
        {'kode':'0','nama':'-- Pilih Jenis Laporan --'},{'kode':'1','nama':'SP2D ( PFK / PERHITUNGAN FIHAK KETIGA )'},
        # {'kode':'2','nama':'NOTA'}, 
        {'kode':'3','nama':'PENDAPATAN DAN PENERIMAAN PEMBIAYAAN'},{'kode':'4','nama':'Pengembalian Tahun Lalu'},{'kode':'5','nama':'Pengembalian UP/GU/TU Tahun Berjalan'},{'kode':'6','nama':'Pengembalian LS Tahun Berjalan'}, 
    ...
    # ADD JOEL 23 Feb 22 ==================== LAPORAN LKPD
    elif jenis_akuntansi=='laporanlkpd':
        judul = 'Laporan LKPD TA. '+tahun
        array_jenis_laporan = [ {'kode':'1','nama':'LRA'}, {'kode':'2','nama':'LPSAL'},
            {'kode':'3','nama':'ARUS KAS'}, {'kode':'4','nama':'NERACA'},
            {'kode':'5','nama':'LPE'}, {'kode':'6','nama':'LO'} ]
        path  = 'laporan/lap_lkpd.html'

    data = {
            # 'organisasi_ppkd':get_PPKD(request)[0]['kode']+' - '+get_PPKD(request)[0]['urai'],
...
def cetak_laporan(request):
    ...
    if jenis_akuntansi=='laporanverifikasi':
        ...
        if jenis_laporan=='1':
            ...
            reportParam['kodeunit']             = "'"+post.get('kdunit')+"'"
        ...
        if jenis_laporan=='1':
            ...
            reportParam['file']         = 'penatausahaan/akuntansi/lra_penjabaran_prognosis.fr3'  
            reportParam['kodeurusan']       = post.get('kdurusan')
            reportParam['kodesuburusan']    = post.get('kdsuburusan')
            reportParam['kodeorganisasi']   = "'"+post.get('kdorganisasi')+"'"
            reportParam['kodeunit']         = "'"+post.get('kdunit')+"'"
            ...
            reportParam['file']         = 'penatausahaan/akuntansi/rekap_pendapatan_pemda.fr3'  
            reportParam['tglawal']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglakhir']     = "'"+tgl_short(post.get('bulan_sampai'))+"'"
            reportParam['tglfrom']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglto']        = "'"+tgl_short(post.get('bulan_sampai'))+"'"
            ...
            reportParam['file']         = 'penatausahaan/akuntansi/rekap_pendapatan_skpd.fr3'  
            reportParam['tglawal']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglakhir']     = "'"+tgl_short(post.get('bulan_sampai'))+"'"
            reportParam['tglfrom']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglto']        = "'"+tgl_short(post.get('bulan_sampai'))+"'"
            ...
            reportParam['file']         = 'penatausahaan/akuntansi/lra_pemdaperiode.fr3'  
            reportParam['tglawal']      = ""+tgl_short(post.get('bulan_ke'))+""
            reportParam['tglakhir']     = ""+tgl_short(post.get('bulan_sampai'))+""
            reportParam['tglfrom']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglto']        = "'"+tgl_short(post.get('bulan_sampai'))+"'"
            ...
            reportParam['file']         = 'penatausahaan/akuntansi/lra_skpdperiode.fr3'  
            reportParam['tglawal']      = ""+tgl_short(post.get('bulan_ke'))+""
            reportParam['tglakhir']     = ""+tgl_short(post.get('bulan_sampai'))+""
            reportParam['tglfrom']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglto']        = "'"+tgl_short(post.get('bulan_sampai'))+"'"
            ...
            reportParam['file']         = 'penatausahaan/akuntansi/penjabaran_skpdperiode.fr3'  
            reportParam['tglawal']      = ""+tgl_short(post.get('bulan_ke'))+""
            reportParam['tglakhir']     = ""+tgl_short(post.get('bulan_sampai'))+""
            reportParam['tglfrom']      = "'"+tgl_short(post.get('bulan_ke'))+"'"
            reportParam['tglto']        = "'"+tgl_short(post.get('bulan_sampai'))+"'"
        ...
        if jenis_peraturan =='0':
            ...
            if jenis_laporan =='1' and versi_sesuai== '0':
                ...
                reportParam['file']             = 'penatausahaan/akuntansipemda/Lampiran2.fr3'
            elif jenis_laporan =='3':
                ...
                reportParam['file']             = 'penatausahaan/akuntansi/Lampiran3.fr3'
            elif jenis_laporan =='5':
                reportParam['file']             = 'penatausahaan/akuntansipemda/Lampiran4.fr3'
            elif jenis_laporan =='6':
                reportParam['file']             = 'penatausahaan/akuntansi/Lampiran5.fr3'
            elif jenis_laporan =='7':
                reportParam['file']             = 'penatausahaan/akuntansi/Lampiran6.fr3'
            elif jenis_laporan =='8':
                reportParam['file']             = 'penatausahaan/akuntansi/Lampiran7.fr3'
            elif jenis_laporan =='9':
                reportParam['file']             = 'penatausahaan/akuntansi/Lampiran8.fr3'
            elif jenis_laporan =='10':
...
def print_lap_lkpd(request):
    ...
    if request.method == 'POST':
        ...
        tahun       = tahun_log(request)
        jns_lap     = int(data.get('jenis_laporan'))
        aidi        = data.get('id_pengguna_akuntansi')
        bln_awal    = data.get('bulan_dari')
        bln_akhir   = data.get('bulan_sampai')
        tgl_cetak   = data.get('tanggal_cetak')

        if(jns_lap == 1): #LRA
            file_lap = 'penatausahaan/lkpd/lra_lkpd.fr3' 
        elif(jns_lap == 2): #LPSAL
            file_lap = 'penatausahaan/lkpd/lpsal_lkpd.fr3'
        elif(jns_lap == 3): #ARUS_KAS
            file_lap = 'penatausahaan/lkpd/aruskas_lkpd.fr3'
        elif(jns_lap == 4): #NERACA
            file_lap = 'penatausahaan/lkpd/neraca_lkpd.fr3'
        elif(jns_lap == 5): #LPE
            file_lap = 'penatausahaan/lkpd/lpe_lkpd.fr3'
        elif(jns_lap == 6): #LO
            file_lap = 'penatausahaan/lkpd/lo_lkpd.fr3'  


        lapParm['report_type']  = 'pdf'
        lapParm['tahun']        = "'"+tahun+"'"
        lapParm['id_pejabat']   = aidi
        lapParm['bln_awal']     = "'"+bln_awal+"'"
        lapParm['bln_akhir']    = "'"+bln_akhir+"'"
        lapParm['tgl_cetak']    = "'"+tgl_cetak+"'"
        lapParm['blnawal']      = "'"+tgl_short(bln_awal)+"'"
        lapParm['blnakhir']     = "'"+tgl_short(bln_akhir)+"'"
        lapParm['tglcetak']     = "'"+tgl_short(tgl_cetak)+"'"
        lapParm['file']         = file_lap

        return HttpResponse(laplink(request, lapParm))

    else:
        data = {}
        return render(request,'akuntansi/laporan/lap_lkpd.html',data)