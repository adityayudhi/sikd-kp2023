...
$('#btn_lihat_sp2d').click(function(){
    render_modal('Lihat SP2D', 'sp2d_gu', []);
});
...
$('#btn_lihat_spm').click(function(){
    if ($('#kd_org2').val()=='') {
        ...
        render_modal('Lihat SPM', 'spm_sp2d', [$('#kd_org2').val(),'GU']);
      }
});
...
function cek_uncek_all_sp2dgu(e, chkclass, page){
    ...
    if(e.checked){
        $('#frm_sp2dgu input[name=cek_'+page+']').val('1');
        ...
        $('#frm_sp2dgu input[name=cek_'+page+']').val('0');
        for (var i = 0; i < pjg_keg; i++) {
