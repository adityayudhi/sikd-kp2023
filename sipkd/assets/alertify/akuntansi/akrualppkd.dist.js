...
var dated = { min: window.spjskpd.min, max: window.spjskpd.max, current: window.spjskpd.current, };
...
['kodeurusan','kodesuburusan','kodeorganisasi'].forEach(pk => {
	...
	*/
	defaults_by_pk: {
		...
		JPLRA: {
			...
			tanggalbukti: tanggalbukti => $(tanggalbukti).trigger('tanggalin', dated.max),
			__1__: opts => {
				$wait.show();
