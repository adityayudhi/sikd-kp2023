...
function loadTabelAfektasi_BARJAS(asal){
  ...
  if(triwul == 0){
      ...
      $.ajax({
        ...
        type: "POST",
        url: link_tabel,
        data: {skpd:skpd, nospm_x:nospm, nosp2d_x:nosp2d, tgl:tanggal, kegiatan:kegiatan, asal:asal,kodeunit:kodeunit},
        async: false,
        dataType: "html",
        timeout: 10000,
...
function getSumberDana_BARJAS(){
  ...
  $.ajax({
      ...
      type: "POST",
      url: link_sumda,
      data: {skpd:skpd, nospm_x:nospm, nosp2d_x:nosp2d, tgl:tanggal, kegiatan:kegiatan, kdrek:kdrek, aksi:aksi,kodeunit:kodeunit},
      async: false,
      dataType: "json",
...
function loadDataSP2D_BARJAS(){
  ...
  $.ajax({
      ...
      type: "POST",
      url: link_sp2d,
      data: {skpd:skpd, nosp2d:nosp2d,kodeunit:kodeunit},
      async: false,
      dataType: "json",
