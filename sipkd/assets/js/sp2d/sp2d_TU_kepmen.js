...
function loadTabelAfektasi_TU_kepmen(asal){
...
function PilihRekening_sp2d_TU_kepmen(){
...
function loadDataSPM_BARJAS(){
  ...
  $.ajax({
      ...
      dataType:"json",
      url: link_spm_c,
      data: {nospm:nospm, skpd:skpd, kodeunit:kodeunit},
      async: false,
      success: function(msg){ 
        ...
        loadTabelAfektasi_TU_kepmen('spm');
        $("#no_sp2d").focus();
            ...
            $.ajax({
                ...
                success: function(x){
                  ...
                  if(x['issimpan'] >= 1){
                    ...
                    loadPertama('btn_hapus','1');
                    loadDataSP2D_BARJAS();
                    if(!isCetak){ cetak_lap_sp2d_TU_kepmen();}
                  }
  ...
  if(skpd == ""){
      ...
      $.alertable.confirm('Apakah anda Yakin Untuk Menghapus Data SP2D Dengan Nomor '+nosp2d+' ?').then(function(){
          $.ajax({
              ...
              dataType:"json",
              success: function(z){
                if(z['issimpan'] == 0){ clearForm_TU_kepmen(); }
...
function cetak_lap_sp2d_TU_kepmen(){
  var skpd   = $("#organisasi").val();
  var nosp2d = $("#no_sp2d_x").val();
  var nospm  = $("#no_spm_x").val();
  ...
  if(skpd == ""){ 
    ...
    showModalLaporan('lap_sp2d_TU_kepmen'); 
  }
}
