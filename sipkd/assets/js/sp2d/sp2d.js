...
$("#btn_lihat_sp2d").click(function(){
  ...
  //} else {
    if(form_sp2d in ['sp2d_barjas','sp2d_gu_kepmen','sp2d_tu_kepmen']){
        ...
        render_modal_list_sp2d('Cari Data SP2D - '+jnsSPM,'src_sp2d',[skpd,jnsSPM]);
...
function getPotongan_sp2d(asal){
  ...
  $.ajax({
    ...
    type: "POST",
    url: link_tbl_pot,
    data: {skpd:skpd, nospm:nospm, nosp2d:nosp2d, asal:asal,kodeunit:kodeunit},
    async: false,
    dataType: "html",
    timeout: 10000,
    success: function(response){
...
//  tambahan list data sp2d modal serverside
function render_modal_list_sp2d(header,dari,arrX){

  $.ajax({
    type: "POST",
    headers: { "X-CSRFToken": csrf_token },
    url: url_modal_sp2d_serverside,
    data: {'jenis':arrX[1], 'skpd':arrX[0], 'dari':dari},
    dataType: 'html',
    beforeSend: function() {
      $(".cover").show();
    },
