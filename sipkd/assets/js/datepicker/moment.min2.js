...
(function(a) {
    ...
    mc.DDDD = g(mc.DDD, 3), l(i.prototype, {
        ...
        _months: "Januari_Februari_Maret_April_Mei_Juni_Juli_Agustus_September_Oktober_November_Desember".split("_"),
        months: function(a) {
            return this._months[a.month()]
        },
        _monthsShort: "Jan_Feb_Mar_Apr_Mei_Jun_Jul_Agu_Sep_Okt_Nov_Des".split("_"),
        ...
        _weekdays: "Minggu_Senen_Selasa_Rabu_Kamis_Jum at_Sabtu".split("_"),
        weekdays: function(a) {
            return this._weekdays[a.day()]
        },
        _weekdaysShort: "Min_Sen_Sel_Rab_Kam_Jum_Sab".split("_"),
        weekdaysShort: function(a) {
            return this._weekdaysShort[a.day()]
        },
        _weekdaysMin: "Mg_Sn_Sl_Rb_Km_Jm_Sb".split("_"),
