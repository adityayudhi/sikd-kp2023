...
function changeJns_pengadaan(){
  ...
  var arr_lop = ["nama_perusahaan","bentuk_perusahaan","alamat_perusahaan","pimp_perusahaan",
                "npwp_perusahaan","bank_perusahaan","norek_perusahaan","nomor_kontrak","nama_rekening_bank_perusahaan"];
...
function showModal_spp_lpj(e,modal){
  ...
  switch(modal) { 
    case 'sp2d_mdl_potongan':
      ...
      url_load  = linkLoad+"?i="+rowid+"&b="+nobuk+"&t="+tglbuk+"&s="+skpd+"&n="+nolpj;
      break;
